...
export const GoogleSignInModal: React.FC<GoogleSignInModalProps> = ({
  ...
  const saveAccountToList = async (acc: GoogleAccount) => {
    try {
  ...
  const handleSelectSavedAccount = (acc: GoogleAccount) => {
    setLocalError(null);
    onSuccess(acc);
  };
      ...
      >
        <View style={styles.sheetContainer}>
          ...
          <ScrollView style={styles.bodyScroll} keyboardShouldPersistTaps="handled">
            {/* List of saved accounts if available and not in manual form */}
